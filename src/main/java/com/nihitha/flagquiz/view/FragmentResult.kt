...
import com.nihitha.flagquiz.databinding.FragmentResultBinding
...
class FragmentResult : Fragment() {
    ...
    override fun onCreateView(
        ...
        barEntriesArrayListCorrect.add(BarEntry(1F,emptyNumber))
        barEntriesArrayListCorrect.add(BarEntry(2F,wrongNumber))
